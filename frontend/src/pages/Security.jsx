...
export default function Security() {
  ...
  const totalPayrollAmount = employees
    .filter(e => e.employment_status === 'active')
    .reduce((sum, emp) => sum + (parseFloat(emp.basic_salary) || 0), 0)
  const securityEvents = 0 // Placeholder for actual security events tracking
  const complianceScore = 98 // Placeholder for actual compliance calculation
    ...
    <Box>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Box display="flex" alignItems="center" gap={2}>
          ...
          <Typography variant="h4" sx={{ fontWeight: 600 }}>Security & Configuration</Typography>
        </Box>
      </Box>

      <Tabs value={activeTab} onChange={(e, v) => setActiveTab(v)} sx={{ mb: 3 }}>
        <Tab label="Security Overview" icon={<SecurityIcon />} iconPosition="start" />
        <Tab label="Payroll Management" icon={<AdminPanelSettings />} iconPosition="start" />
        <Tab label="Payroll Configuration" icon={<Lock />} iconPosition="start" />
      </Tabs>
        ...
        <Box>
          <Grid container spacing={3} mb={3}>
            <Grid item xs={12} md={3}>
              <Card sx={{ background: 'linear-gradient(135deg, #1a365d 0%, #2d3748 100%)', color: 'white' }}>
                <CardContent>
                  <Box display="flex" alignItems="center" gap={2}>
                    <VerifiedUser sx={{ fontSize: 40 }} />
                    <Box>
                      <Typography variant="h4" sx={{ fontWeight: 700 }}>{activeEmployees}</Typography>
            ...
            <Grid item xs={12} md={3}>
              <Card sx={{ background: 'linear-gradient(135deg, #d4af37 0%, #b8941e 100%)', color: 'white' }}>
                <CardContent>
                  <Box display="flex" alignItems="center" gap={2}>
                    <Shield sx={{ fontSize: 40 }} />
                    <Box>
                      <Typography variant="h4" sx={{ fontWeight: 700 }}>{complianceScore}%</Typography>
              ...
              <Card sx={{ background: 'linear-gradient(135deg, #2563eb 0%, #1e40af 100%)', color: 'white' }}>
                <CardContent>
                  <Box display="flex" alignItems="center" gap={2}>
                    ...
                    <Box>
                      <Typography variant="h4" sx={{ fontWeight: 700 }}>KES {totalPayrollAmount.toLocaleString()}</Typography>
              ...
              <Card sx={{ background: 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)', color: 'white' }}>
                <CardContent>
                  <Box display="flex" alignItems="center" gap={2}>
                    <Lock sx={{ fontSize: 40 }} />
                    <Box>
                      <Typography variant="h4" sx={{ fontWeight: 700 }}>{securityEvents}</Typography>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Paper sx={{ p: 3 }}>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 600 }}>System Security Status</Typography>
                <Divider sx={{ mb: 2 }} />
                <Box display="flex" flexDirection="column" gap={2}>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>Data Encryption</Typography>
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>Audit Logging</Typography>
                    <Chip label="Active" color="success" size="small" />
                  </Box>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>Data Backup</Typography>
            ...
            <Grid item xs={12} md={6}>
              <Paper sx={{ p: 3 }}>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 600 }}>Compliance & Regulations</Typography>
                <Divider sx={{ mb: 2 }} />
                <Box display="flex" flexDirection="column" gap={2}>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>KRA Tax Compliance</Typography>
                    <Chip label="Compliant" color="success" size="small" />
                  </Box>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>NSSF Contributions</Typography>
                    <Chip label="Up to Date" color="success" size="small" />
                  </Box>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>SHIF Contributions</Typography>
                    <Chip label="Up to Date" color="success" size="small" />
                  </Box>
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Typography>Labor Law Compliance</Typography>
                    <Chip label="Compliant" color="success" size="small" />
                  </Box>
                </Box>
              </Paper>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 600 }}>Recent Security Activity</Typography>
                <Divider sx={{ mb: 2 }} />
                <Typography variant="body2" color="text.secondary">No recent security events detected. System is operating normally.</Typography>
              </Paper>
            </Grid>
          </Grid>
        </Box>
